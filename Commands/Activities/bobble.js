        ...
        if (!message.member.voice.channel) {
            ...
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'bobble').then(async invite => {
                const StartACT = new EmbedBuilder()
                    .setColor(14024959)
                    .setAuthor({ name: `กิจกรรม Bobble League` , iconURL: 'https://cdn.discordapp.com/attachments/1071401485239332864/1073205416328183908/00000-4163793642-Anime_girl_cat_purple_smile.png'})
